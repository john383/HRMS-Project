    ...
    if(isset($_POST['update_password'])){
        ...
        if($checkPwd === false){
            ...
            if($new == $confirm){
                ...
                $upd_pass = "UPDATE admin SET password = ? WHERE adminId = ?";
                        ...
                        <form action="" method="post">
                            <div class="mb-5">
                                <div class="col">
                                    ...
                                    <input type="password" class="form-control" name="cur_pass" id="cur_pass" placeholder="Current Password" required>
                                </div>
                                <div class="col">
                            ...
                            <input type="submit" value="Update Password" name="update_password" class="form-control btn btn-success">                              
                        </form>
                    </div>
            </div>
        </div>
