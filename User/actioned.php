...
?>
    <nav>
        <div class="sidebar-button">
            ...
            <span class="dashboard"><b>Actioned Leaves</b></span>
        </div>
        <div class="time">
        ...
        <div class="cardbox">
            <div class="graphbox">
			   <div class="year-box">
                    ...
                    ?>
                    <select id="month" name="month" onchange="getactionedleave()">
                    ...
                    <?php 
                        echo '<select id="year" name="year" onchange="getactionedleave()">'."\n";
